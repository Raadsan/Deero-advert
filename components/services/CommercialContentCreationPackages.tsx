...
const contentPlans = [
    {
        name: "Faynuus Package",
        price: 350,
        features: [
            "4K Multi-Angle Video Recording",
            "Advanced Editing & Motion Graphics",
            "Creative Script Writing (Up to 3 Minutes)",
            "Unique Logo and Lower Third",
        ],
        buttonColor: "bg-[#f28b6d]",
        isPopular: false,
    },
    {
        name: "Dhalaal Package",
        price: 470,
        features: [
            "Marketing and Advertising Plan",
            "Storytelling and Concept Creation",
            "Short Business Documentary",
            "4K Multi-Angle Video Recording and Drone Videography",
        ],
    ...
    },
    {
        ...
        features: [
            "Marketing and Advertising Plan",
            "4K Multi-Angle Video Recording and Drone Videography",
            "Advanced Editing (Up to 3 Minutes)",
