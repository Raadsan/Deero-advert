    ...
    return (
        <footer className="relative w-full bg-[#4d0e0e] text-white">
            ...
            <a
                ...
                className="fixed bottom-24 right-6 z-40 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300 group"
