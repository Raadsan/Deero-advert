        ...
        const fetchGallery = async () => {
            try {
                ...
                if (data.success) {
                    ...
                    const target = portfolios.find((p: any) => p.title === "Digital Consulting");
                    if (target && target.gallery) {
                        setGallery(target.gallery);
                    }
                }
            } catch (error) {
                console.error("Error fetching digital consulting gallery:", error);
            } finally {
                setLoading(false);
            }
        };
                                ...
                                gallery.map((img, index) => (
                                    ...
                                    >
                                        <Image
                                            ...
                                            alt={`Digital Consulting ${index + 1}`}
                                            fill
