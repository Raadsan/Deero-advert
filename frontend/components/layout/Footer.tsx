        ...
        <footer className="relative w-full bg-[#4d0e0e] text-white">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8 items-start">
                    ...
                    <div className="lg:col-span-2 flex flex-col items-start gap-4 md:pr-10 lg:pr-14">
                        <Image
                            src="/4 (2).png"
                            alt="Deero Advert"
                            width={300}
                        ...
                        <div className="flex flex-row flex-wrap gap-2 mt-4">
                            <a href="#" className="flex items-center gap-2 bg-white text-[#651313] px-3 py-1.5 rounded-lg hover:bg-[#fcd7c3] transition-all shadow-sm">
                                ...
                                <div className="text-left leading-none">
                                    <p className="text-[7px] uppercase font-bold text-[#651313]/60 mb-0.5">Download on</p>
                                    <p className="text-[10px] font-black">App Store</p>
                                </div>
                            </a>
                            <a href="#" className="flex items-center gap-2 bg-white text-[#651313] px-3 py-1.5 rounded-lg hover:bg-[#fcd7c3] transition-all shadow-sm">
                                <svg viewBox="0 0 512 512" width="16" height="16" fill="currentColor">
                                    <path d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zm-278.3-234.3C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z"/>
                                </svg>
                                <div className="text-left leading-none">
                                    <p className="text-[7px] uppercase font-bold text-[#651313]/60 mb-0.5">GET IT ON</p>
