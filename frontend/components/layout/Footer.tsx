                        ...
                        <div className="flex gap-3 pt-10">
                            {[
                                ...
                                },
                                {
                                    ...
                                    icon: (
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M6.938 4.503c.702 0 1.34.06 1.92.188.577.13 1.07.33 1.485.602.414.272.738.621.97 1.049.233.429.35.939.35 1.534 0 .66-.15 1.21-.445 1.65-.297.44-.738.8-1.325 1.078.803.233 1.408.639 1.818 1.213.41.573.614 1.26.614 2.061 0 .66-.127 1.23-.382 1.72-.254.49-.607.895-1.056 1.215-.45.32-.977.557-1.58.71-.604.154-1.245.23-1.92.23H0V4.503zm-.54 4.217H2.165V.0504H6.34c.66 0 1.21.082 1.647.248.437.164.78.388 1.026.67.246.28.42.608.52.977.101.37.15.764.15 1.18 0 .78-.194 1.394-.582 1.838-.388.445-.981.666-1.779.666H6.4zm0 4.78H2.165v3.346H6.676c.528 0 .99-.055 1.393-.164.402-.109.74-.273 1.014-.49.272-.218.476-.49.608-.814.133-.323.2-.694.2-1.107 0-.832-.247-1.455-.74-1.867-.493-.413-1.2-.62-2.115-.62h-.638zm8.636-4.717h5.73V7.5h-5.73V8.78zM21.5 9.5c0-1.34-.38-2.41-1.14-3.21-.76-.8-1.82-1.2-3.17-1.2-1.38 0-2.47.42-3.27 1.26-.8.84-1.2 1.96-1.2 3.36 0 1.48.39 2.62 1.17 3.43.78.81 1.88 1.22 3.3 1.22 1.05 0 1.93-.24 2.64-.73.71-.49 1.19-1.23 1.43-2.24h-2.04c-.1.39-.32.7-.66.91-.34.21-.75.32-1.22.32-.6 0-1.09-.17-1.47-.5-.38-.33-.59-.85-.63-1.56H21.5zm-5.27-2.45c.34-.3.79-.45 1.35-.45.54 0 .98.14 1.32.43.34.29.53.71.57 1.27h-3.83c.07-.57.25-1 .59-1.25z"/>
                                        </svg>
                                    )
                                },
                            ].map((social) => (
