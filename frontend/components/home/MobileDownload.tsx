                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-8">
                    ...
                    <div className="flex-1 space-y-6 md:space-y-8 z-10 text-left md:ml-8 md:pb-10">
                        ...
                        <div className="flex flex-row items-center gap-2 sm:gap-4">
                            ...
                            <Link
                                href="#"
                                className="flex items-center gap-2 sm:gap-3 bg-[#651313] px-3 py-2 sm:px-5 sm:py-2.5 rounded-xl transition-transform hover:scale-105 active:scale-95 shadow-lg flex-1 sm:flex-none justify-center"
                            >
                                ...
                                <div className="flex flex-col leading-none">
                                    <span className="text-[8px] sm:text-[10px] font-bold text-white/80 uppercase tracking-tight">Download on</span>
                                    <span className="text-sm sm:text-lg font-black text-white whitespace-nowrap">App Store</span>
                                </div>
                            </Link>
                            ...
                            >
                                ...
                                <div className="flex flex-col leading-none">
                                    <span className="text-[8px] sm:text-[10px] font-bold text-white/80 uppercase tracking-tight">GET IT ON</span>
                                    <span className="text-sm sm:text-lg font-black text-white whitespace-nowrap">Google Play</span>
                                </div>
                            </Link>
                        </div>
                    </div>
